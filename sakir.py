...
sakir = Client(
    ...
    bot_token=bot_token,
    api_id=6,
    api_hash="9b892aec383e1ca839782828c671f0ac",
)
...
@sakir.on_message(filters.command("bilgi") & ~filters.edited)
async def bilgi(_, message):
    await message.reply_text(
        "[Admin](https://t.me/SancakBegi)"
        + " | [Diğer Botlar](t.me/SancakBotlar)",
...
async def start(_, message):
    ...
    await sleep(2)
    await message.reply_text("/bilgi - BOT HAKKINDA BİLGİ")
